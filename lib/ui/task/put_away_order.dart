...
class PutAwayOrderScreen extends StatefulWidget {
  @override
  _PutAwayOrderScreenState createState() => _PutAwayOrderScreenState();
}

class _PutAwayOrderScreenState extends State<PutAwayOrderScreen> {
  //stores:---------------------------------------------------------------------
