...
class PickedOrderConfirmationScreen extends StatefulWidget {
  final List<OrderItem> item;

  const PickedOrderConfirmationScreen({super.key, required this.item});

  @override
  _PickedOrderConfirmationScreenState createState() => _PickedOrderConfirmationScreenState();
}

class _PickedOrderConfirmationScreenState extends State<PickedOrderConfirmationScreen> {
  //stores:---------------------------------------------------------------------
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      floatingActionButton: FloatingActionButton.extended(label: Text('Finish'),onPressed: (){
