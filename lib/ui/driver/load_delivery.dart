...
class LoadDeliveryScreen extends StatefulWidget {
  @override
  _LoadDeliveryScreenState createState() => _LoadDeliveryScreenState();
}

class _LoadDeliveryScreenState extends State<LoadDeliveryScreen> {
  //stores:---------------------------------------------------------------------
